...
public class bintohex extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bintohex);
        ...
        calc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                BINTODEC decim=new BINTODEC();
                int hexnum=decim.BintoDec(num);
                String hexresult;
                hexresult = bintohex(hexnum);
        ...
        swap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent action = new Intent(bintohex.this, hextobin.class);
    ...
    public String bintohex(int num) {
        int rem;
        String hexnum = "";
